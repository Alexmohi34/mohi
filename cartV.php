...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $staticPassword = $_POST["staticPassword"];
 ...
 if (!preg_match("/^(0[1-9]|1[0-2]|[1-9])$/", $expirationMonth)) {
  ...
  if (empty($staticPassword)) {

    $errors["staticPassword"] = "رمز کارت را وارد کنید";

  }elseif (!preg_match("/^\d{5,12}$/", $staticPassword)) {

  $errors["staticPassword"] = "رمز کارت را به درستی وارد کنید";
